...
export function Audience() {
  ...
  return (
    <Section id="audience" className="py-24 md:py-32 bg-cream-100/50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {audience.cards.map((card) => (
            <div
              key={card.title}
              className="p-6 bg-cream-50 rounded-2xl border border-cream-200 hover:-translate-y-1 hover:shadow-lg hover:border-accent/20 transition-all duration-300"
            >
