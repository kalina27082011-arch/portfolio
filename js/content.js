    ...
    items: [
      {
        ...
        text: 'Людмила быстро поняла нашу задачу и сделала сайт, который реально продаёт. Всё чётко, красиво и без лишней бюрократии. Рекомендую!',
        rating: 5,
      },
      {
        name: 'Дмитрий Соколов',
        role: 'Предприниматель',
        text: 'Нужен был лендинг за две недели — получил раньше срока. Коммуникация на высоте: всегда на связи, объясняет простым языком. Буду обращаться снова.',
        rating: 5,
      },
      {
        name: 'Елена Морозова',
        role: 'Эксперт по нутрициологии',
        text: 'Помогла запустить платформу для онлайн-консультаций с нуля. Продумала UX так, что клиенты сразу понимают, как записаться. Очень довольна результатом.',
        rating: 5,
      },
      {
        name: 'Игорь Волков',
        role: 'CEO стартапа',
        text: 'Сделали MVP за месяц — именно то, что нужно было для тестирования гипотез. Код чистый, архитектура позволяет масштабироваться. Отличный партнёр для старта.',
        rating: 5,
      },
      {
        name: 'Мария Кузнецова',
        role: 'Владелица салона красоты',
        text: 'Сайт с онлайн-записью работает без сбоев уже полгода. Людмила учла все наши пожелания и предложила удобные решения, о которых мы сами не подумали.',
        rating: 5,
      },
      {
        name: 'Алексей Новиков',
        role: 'Фотограф',
        text: 'Портфолио получилось стильным и быстрым. Галерея загружается моментально, форма заказов приносит новых клиентов каждую неделю.',
        rating: 5,
      },
    ],
  },
