const ICONS = {
  ...
  max: '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M6 2h12a4 4 0 014 4v12a4 4 0 01-4 4H6a4 4 0 01-4-4V6a4 4 0 014-4zm1.2 5.6v8.8h2.1V11l2.4 3.6h1.6l2.4-3.6v5.4h2.1V7.6H13l-2.7 4.1L7.6 7.6H7.2z"/></svg>',
